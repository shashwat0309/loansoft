...
<body onload="today_date();">
 <div class="left-sidebar-pro">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                         ...
                         <li>
                            <a title="Landing Page" href="<?php echo base_url();?>/Home/metal_cost" aria-expanded="false"><span class="educate-icon educate-department icon-wrap" aria-hidden="true"></span> <span class="mini-click-non" style="color: black"><strong>Metal Cost</strong></span></a>
                        </li>
                         <li>
    ...
    <div class="all-content-wrapper">
                        ...
                        <div class="sparkline10-list mg-tb-30 responsive-mg-t-0 table-mg-t-pro-n dk-res-t-pro-0 nk-ds-n-pro-t-0">
                            ...
                            <div class="sparkline10-graph">
                                <div class="input-knob-dial-wrap">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="chosen-select-single mg-b-20">
                                                ...
                                                <select data-placeholder="Choose Metal Name" class="chosen-select" id="metal_name" tabindex="-1">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                            <div class="form-group-inner">
                                                ...
                                                <input type="number" id="metal_cost" class="form-control" placeholder="Metal Cost"/>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                           <button class="btn btn-block btn-info login-submit-cs" style="background-color: #006DF0;" onclick="submit_cost();">Submit</button>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
        ...
        <div class="footer-copyright-area-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
